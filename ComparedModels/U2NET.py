...
def train():
    ...
    print('Fitting model...')
    model.fit(imgs_train, imgs_mask_train, batch_size=12, epochs=2, verbose=1, shuffle=True,
              callbacks=[model_checkpoint])
    # model.save('myu2net.h5')
    print('predict test data')
    i = 0
    piclist = []
    for line in open("./results2/pic.txt"):
        line = line.strip()
    ...
    for img in imgs_test:
        ...
        print("model",model(input_tensor))
        print("fused",fused_mask_tensor)
        path = "./results2/" + piclist[i]
